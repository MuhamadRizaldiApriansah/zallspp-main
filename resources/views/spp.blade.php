      ...
      <div class="modal-body">
        <form action="{{ route('spp.tambah') }}" method="post">
          ...
          <div class="form-group my-1">
            ...
            <input type="text" class="form-control" id="bulan" name="bulan" value="" required placeholder="Masukan bulan">
          </div>

          <div class="form-group my-1">
            <label for="nominal">Nominal :</label>
            <input type="text" class="form-control" id="nominal" name="nominal" {{ $item->nominal }} required placeholder="Masukan nominal">
          </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('spp.update', $item->id) }}" method="post">
          ...
          <div class="form-group my-1">
            <label for="tahun">Tahun :</label>
            <input type="text" class="form-control" id="tahun" name="tahun" value="{{ $item->tahun }}" required placeholder="Masukan tahun">
          </div>

          <div class="form-group my-1">
            <label for="bulan">Bulan :</label>
            <input type="text" class="form-control" id="bulan" name="bulan" value="{{ $item->bulan }}" required placeholder="Masukan bulan">
          </div>

          <div class="form-group my-1">
            <label for="nominal">Nominal :</label>
            <input type="text" class="form-control" id="nominal" name="nominal" value="{{ $item->nominal }}" required placeholder="Masukan nominal">
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
